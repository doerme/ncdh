...
*/
 export default function hiToast(text,options) {
	var defaultOptions = {
	...
	var width = ($(window).width() / 2- $(".toast").width() /2) +"px";
	var height = '20px';
	if (options.position == 'top') {
		height = ($(window).height() * 1 / 5- $(".toast").height() /2) +"px";
	}else if (options.position == 'center') {
		height = ($(window).height() / 2 - $(".toast").height() /2) +"px";
	}else if (options.position == 'bottom') {
		height = ($(window).height() * 4 / 5- $(".toast").height() /2) +"px";
	}
